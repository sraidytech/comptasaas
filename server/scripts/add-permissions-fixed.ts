...
// Define a local interface for our permission data that includes category
// This won't conflict with Prisma's generated types
interface PermissionData {
  name: string;
  description: string;
  category?: string; // Make category optional to avoid TypeScript errors
}
  ...
  for (const permissionData of permissions) {
    try {
      ...
      if (existingPermission) {
        // Update the permission without category
        ...
        // Create new permission without category
      ...
      console.error(`Error processing permission ${permissionData.name}:`, error);
    }
  }
